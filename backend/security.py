...
# on the server. A random one is generated on first import so the server at
# least doesn't ship with a hardcoded shared secret.
SECRET_KEY = os.environ.get("NOTEBOOK_SECRET_KEY") or os.urandom(32).hex()
ALGORITHM = "HS256"
