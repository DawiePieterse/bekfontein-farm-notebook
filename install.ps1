# Bekfontein Farm Notebook - Windows server installer
#
...
$Port = 8001
$TaskName = "Bekfontein Farm Notebook Server"
$FirewallRuleName = "Bekfontein Farm Notebook Server"
...
try {
    ...
    Write-Host ""
    Write-Host "Bekfontein Farm Notebook - Server Installer" -ForegroundColor Cyan
...
"@
    ...
    Write-Host "================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host " On this PC:                        http://localhost:$Port/app/"
    if ($ip) {
        Write-Host " From other devices on the network: http://$ip`:$Port/app/"
    } else {
    ...
    Write-Warn "  son   / ChangeMe123!  (viewer - read-only)"
    ...
    Write-Host "================================================" -ForegroundColor Cyan
    Write-Host " This is a separate, opt-in script - it did not run just now."
    Write-Host " See MANUAL.md chapter 2 for details."
    Write-Host ""
